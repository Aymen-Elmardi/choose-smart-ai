...
export const metadata: Metadata = {
  title: 'Same-Day Settlement & Instant Payouts: Which Providers Offer It',
  ...
  openGraph: {
    url: 'https://chosepayments.com/insights/same-day-settlement-and-instant-payouts',
...
export default function Page() {
  return <SameDaySettlementAndInstantPayouts />
}

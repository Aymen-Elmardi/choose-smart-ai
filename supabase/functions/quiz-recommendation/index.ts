...
interface ProviderConfig {
  ...
  exclusions: string[];
  strengths: string[];
  // Segments this provider is especially strong for (secondary scoring axis)
  segmentFit?: Segment[];
}
...
interface RecommendationResult {
  bestMatch: { name: string; description: string; reasons: string[]; score?: number };
...
const PROVIDER_REGISTRY: ProviderConfig[] = [
  ...
  { id: "braintree", name: "Braintree", description: "PayPal-owned platform with robust subscription billing and developer tools.", paymentTypes: ["online", "subscriptions", "marketplace"], terminalSupport: ["none"], marketplaceCapability: true, splitPaymentsSupport: true, regions: ["both"], minimumMonthlyVolume: 5000, riskAppetite: { "ecommerce": "green", "saas": "green", "subscription": "green", "marketplace": "green", "gambling": "red", "adult": "red", "subscription-ecommerce": "green", "food-delivery": "amber", "ticketing": "green", "education": "green", "gaming": "red" }, exclusions: ["gambling", "adult"], strengths: ["subscriptions", "developer-friendly", "paypal-venmo", "recurring-billing"], segmentFit: ["saas", "marketplace"] },
  { id: "mollie", name: "Mollie", description: "European payment service provider known for simple integration and local payment methods.", paymentTypes: ["online", "subscriptions"], terminalSupport: ["portable-sim"], marketplaceCapability: true, splitPaymentsSupport: true, regions: ["both"], minimumMonthlyVolume: 0, riskAppetite: { "ecommerce": "green", "saas": "green", "retail": "green", "hospitality": "green", "gambling": "red", "adult": "red", "subscription-ecommerce": "green", "food-delivery": "green", "ticketing": "green", "education": "green", "gaming": "red" }, exclusions: ["gambling", "adult"], strengths: ["european", "local-payment-methods", "simple-integration", "transparent-pricing"], segmentFit: ["self-hosted", "saas", "marketplace"] },
  ...
  { id: "gocardless", name: "GoCardless", description: "Specialist in recurring Direct Debit payments for subscriptions and invoicing.", paymentTypes: ["subscriptions"], terminalSupport: ["none"], marketplaceCapability: false, splitPaymentsSupport: false, regions: ["both"], minimumMonthlyVolume: 0, riskAppetite: { "saas": "green", "subscription": "green", "utilities": "green", "membership": "green", "professional-services": "green", "gambling": "red", "adult": "red", "subscription-ecommerce": "green", "food-delivery": "red", "ticketing": "red", "education": "green", "gaming": "red" }, exclusions: ["gambling", "adult"], strengths: ["direct-debit", "recurring", "low-fees", "subscription-focused"], segmentFit: ["saas"] },
  { id: "dojo", name: "Dojo", description: "UK card machine provider with next-day settlements and simple pricing.", paymentTypes: ["in-person", "online"], terminalSupport: ["wired", "portable-sim"], marketplaceCapability: false, splitPaymentsSupport: false, regions: ["UK"], minimumMonthlyVolume: 0, riskAppetite: { "retail": "green", "hospitality": "green", "food-beverage": "green", "professional-services": "green", "gambling": "red", "adult": "red", "subscription-ecommerce": "red", "food-delivery": "green", "ticketing": "red", "education": "green", "gaming": "red" }, exclusions: ["gambling", "adult"], strengths: ["fast-settlement", "uk-focused", "card-machines", "hospitality"], segmentFit: ["multi-location"] },
  { id: "opp", name: "OPP (Online Payment Platform)", description: "Specialist marketplace payment platform with strong support for complex payout structures.", paymentTypes: ["online", "marketplace"], terminalSupport: ["none"], marketplaceCapability: true, splitPaymentsSupport: true, regions: ["both"], minimumMonthlyVolume: 20000, riskAppetite: { "marketplace": "green", "franchise": "green", "platform": "green", "ecommerce": "green", "gambling": "red", "adult": "red", "subscription-ecommerce": "amber", "food-delivery": "amber", "ticketing": "green", "education": "amber", "gaming": "red" }, exclusions: ["gambling", "adult"], strengths: ["marketplace-specialist", "split-payments", "flexible-payouts", "platform-focus"], segmentFit: ["marketplace"] },
  { id: "elavon", name: "Elavon", description: "Major global payment processor with strong presence in hospitality and retail.", paymentTypes: ["online", "in-person"], terminalSupport: ["wired", "portable-sim"], marketplaceCapability: false, splitPaymentsSupport: false, regions: ["both"], minimumMonthlyVolume: 5000, riskAppetite: { "retail": "green", "hospitality": "green", "travel": "green", "ecommerce": "green", "gambling": "red", "adult": "red", "subscription-ecommerce": "green", "food-delivery": "green", "ticketing": "green", "education": "green", "gaming": "red" }, exclusions: ["gambling", "adult"], strengths: ["enterprise", "hospitality", "global-reach", "travel"], segmentFit: ["multi-location"] },
  { id: "airwallex", name: "Airwallex", description: "Global payments platform optimized for international businesses and multi-currency operations.", paymentTypes: ["online"], terminalSupport: ["none"], marketplaceCapability: true, splitPaymentsSupport: true, regions: ["both"], minimumMonthlyVolume: 10000, riskAppetite: { "ecommerce": "green", "saas": "green", "marketplace": "green", "professional-services": "green", "gambling": "red", "adult": "red", "subscription-ecommerce": "green", "food-delivery": "amber", "ticketing": "amber", "education": "green", "gaming": "red" }, exclusions: ["gambling", "adult"], strengths: ["multi-currency", "international", "fx-optimization", "global-payouts"], segmentFit: ["self-hosted", "marketplace"] },
  { id: "stripe", name: "Stripe", description: "Developer-first payment platform with a powerful billing engine, ideal for online and subscription businesses.", paymentTypes: ["online", "subscriptions", "marketplace"], terminalSupport: ["none"], marketplaceCapability: true, splitPaymentsSupport: true, regions: ["both"], minimumMonthlyVolume: 0, riskAppetite: { "ecommerce": "green", "saas": "green", "subscription": "green", "marketplace": "green", "digital-goods": "green", "professional-services": "green", "fashion": "green", "gambling": "red", "adult": "red", "crypto": "red", "cbd": "red", "subscription-ecommerce": "green", "food-delivery": "green", "ticketing": "green", "education": "green", "gaming": "red" }, exclusions: ["gambling", "adult", "crypto", "cbd", "firearms", "tobacco"], strengths: ["developer-friendly", "subscriptions", "recurring-billing", "dunning", "transparent-pricing", "international", "easy-setup"], segmentFit: ["self-hosted", "saas"] },
  { id: "stripe-connect", name: "Stripe Connect", description: "Stripe's marketplace product with automated seller onboarding, payouts, and built-in compliance.", paymentTypes: ["online", "marketplace", "subscriptions"], terminalSupport: ["none"], marketplaceCapability: true, splitPaymentsSupport: true, regions: ["both"], minimumMonthlyVolume: 0, riskAppetite: { "marketplace": "green", "platform": "green", "ecommerce": "green", "saas": "green", "gambling": "red", "adult": "red", "crypto": "red", "subscription-ecommerce": "green", "food-delivery": "green", "ticketing": "green", "education": "green", "gaming": "red" }, exclusions: ["gambling", "adult", "crypto"], strengths: ["marketplace", "split-payments", "seller-onboarding", "automated-payouts", "developer-friendly", "easy-setup"], segmentFit: ["marketplace"] },
...
const validateQuizAnswers = (data: unknown): QuizAnswers | null => {
  ...
  if (!isValidOptionalString(obj.platform)) return null;
  if (!isValidOptionalString(obj.segment)) return null;
  ...
  return {
    ...
    segment: obj.segment as Segment | undefined,
  };
};
...
const scoreProviders = (providers: ProviderConfig[], answers: QuizAnswers): ScoredProvider[] => {
  ...
  return providers.map((provider) => {
    ...
    // Segment Fit — strong secondary axis (+25 when the provider specialises
    // in the caller's business segment)
    if (segment && segment !== "unknown" && segment !== "shopify" && provider.segmentFit?.includes(segment)) {
      score += 25;
      const segmentReason: Record<string, string> = {
        "self-hosted": "Proven fit for self-hosted ecommerce",
        marketplace: "Specialist in multi-merchant marketplace settlement",
        saas: "Built for recurring subscription billing",
        "multi-location": "Strong omnichannel multi-location support",
        "high-risk": "Experienced with high-risk verticals",
      };
      if (segmentReason[segment]) reasons.unshift(segmentReason[segment]);
    }
...
const getRecommendations = (answers: QuizAnswers): RecommendationResult | null => {
  ...
  // Stripe and Stripe Connect are self-serve platforms we don't monetise as
  // processing-merchant leads. Only surface them to non-target leads (Shopify);
  // for every other segment, drop them so the next best processor is recommended.
  const STRIPE_IDS = new Set(["stripe", "stripe-connect"]);
  const pool =
    answers.segment === "shopify"
      ? scored
      : scored.filter((s) => !STRIPE_IDS.has(s.provider.id));

  // Safety net: if filtering somehow emptied the pool (Stripe was the only
  // survivor), fall back to the unfiltered list rather than returning nothing.
  const ranked = pool.length > 0 ? pool : scored;

  const bestMatch = ranked[0];
  const acceptable = ranked.slice(1, 3);
...
const handler = async (req: Request): Promise<Response> => {
  ...
  const limit = await checkRateLimit(adminClient(), { fn: "quiz-recommendation", perIp: 10, windowMinutes: 1 }, clientIp);
  if (!limit.allowed) {

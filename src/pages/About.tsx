...
const About = () => {
  useSEO({
    title: "About ChosePayments | The Missing Layer in Payment Strategy",
    description: "ChosePayments was founded to solve a systemic issue within the payments industry: the recurring cycle of high potential businesses being matched with the wrong providers."
  });

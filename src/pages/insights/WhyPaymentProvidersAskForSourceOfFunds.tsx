      ...
      <main className="pt-24 pb-16">
        <article className="section-container max-w-3xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none text-muted-foreground space-y-6">
            ...
            <p>
              If you want to understand how providers assess risk as your business grows, you can start a short assessment to see how your setup is likely to be viewed.
            </p>

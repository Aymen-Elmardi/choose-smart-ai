      ...
      <main className="pt-24 pb-16">
        <article className="section-container max-w-3xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none text-muted-foreground space-y-6">
            ...
            <p>
              If you want to sense check whether your current setup still aligns with your provider's expectations, you can use our <Link to="/quiz" className="text-primary hover:underline">short assessment</Link>. It helps identify mismatches before they turn into surprises.
            </p>

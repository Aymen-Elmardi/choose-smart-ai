...
const WhyPaymentProvidersAskForDirectorDocuments = () => {
  useSEO({
    title: "Why Payment Providers Ask for a Director's Passport or Proof of Address | ChosePayments",
      ...
      <main className="pt-24 pb-16">
        <article className="section-container max-w-3xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none text-muted-foreground space-y-6">
            ...
            <p>
              If you want help understanding how providers assess risk or whether your setup is likely to trigger additional checks, you can start a short assessment to see how providers are likely to view your business.
            </p>

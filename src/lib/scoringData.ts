...
export const PROVIDER_REGISTRY: ProviderConfig[] = [
  ...
  { id: "paypal", name: "PayPal", description: "Trusted by millions of buyers worldwide.", paymentTypes: ["online"], terminalSupport: ["none"], marketplaceCapability: false, splitPaymentsSupport: false, regions: ["both"], minimumMonthlyVolume: 0, riskAppetite: { "ecommerce": "green", "retail": "green", "digital-goods": "green", "gambling": "red", "adult": "red", "crypto": "red" }, exclusions: ["gambling", "adult", "crypto"], strengths: ["trusted-brand", "buyer-protection", "easy-setup", "low-volume-friendly"] },
  { id: "adyen", name: "Adyen", description: "Enterprise-grade payment platform for high-volume international businesses.", paymentTypes: ["online", "in-person", "marketplace", "subscriptions"], terminalSupport: ["wired", "portable-sim"], marketplaceCapability: true, splitPaymentsSupport: true, regions: ["both"], minimumMonthlyVolume: 50000, riskAppetite: { "ecommerce": "green", "marketplace": "green", "travel": "green", "retail": "green", "hospitality": "green", "gambling": "amber", "adult": "red" }, exclusions: ["adult"], strengths: ["enterprise", "international", "omnichannel", "high-volume", "unified-commerce"] },
  ...
  { id: "mollie", name: "Mollie", description: "European PSP known for simple integration.", paymentTypes: ["online", "subscriptions"], terminalSupport: ["portable-sim"], marketplaceCapability: true, splitPaymentsSupport: true, regions: ["both"], minimumMonthlyVolume: 0, riskAppetite: { "ecommerce": "green", "saas": "green", "retail": "green", "hospitality": "green", "gambling": "red", "adult": "red" }, exclusions: ["gambling", "adult"], strengths: ["european", "local-payment-methods", "simple-integration", "transparent-pricing"] },
  ...
  { id: "checkout-com", name: "Checkout.com", description: "Enterprise payment platform with global coverage.", paymentTypes: ["online", "subscriptions", "marketplace"], terminalSupport: ["none"], marketplaceCapability: true, splitPaymentsSupport: true, regions: ["both"], minimumMonthlyVolume: 100000, riskAppetite: { "ecommerce": "green", "travel": "green", "gaming": "amber", "crypto": "amber", "gambling": "amber", "adult": "red" }, exclusions: ["adult"], strengths: ["enterprise", "global", "high-volume", "fraud-prevention"] },
  ...
  { id: "revolut-business", name: "Revolut Business", description: "Modern business account with integrated payment acceptance.", paymentTypes: ["online", "in-person"], terminalSupport: ["portable-sim"], marketplaceCapability: false, splitPaymentsSupport: false, regions: ["both"], minimumMonthlyVolume: 0, riskAppetite: { "ecommerce": "green", "saas": "green", "professional-services": "green", "retail": "green", "gambling": "red", "adult": "red", "crypto": "amber" }, exclusions: ["gambling", "adult"], strengths: ["multi-currency", "modern-banking", "international", "fast-setup"] },
  ...
  { id: "dojo", name: "Dojo", description: "UK card machine provider with next-day settlements.", paymentTypes: ["in-person", "online"], terminalSupport: ["wired", "portable-sim"], marketplaceCapability: false, splitPaymentsSupport: false, regions: ["UK"], minimumMonthlyVolume: 0, riskAppetite: { "retail": "green", "hospitality": "green", "food-beverage": "green", "professional-services": "green", "gambling": "red", "adult": "red" }, exclusions: ["gambling", "adult"], strengths: ["fast-settlement", "uk-focused", "card-machines", "hospitality"] },
  ...
  { id: "airwallex", name: "Airwallex", description: "Global payments platform for international businesses.", paymentTypes: ["online"], terminalSupport: ["none"], marketplaceCapability: true, splitPaymentsSupport: true, regions: ["both"], minimumMonthlyVolume: 10000, riskAppetite: { "ecommerce": "green", "saas": "green", "marketplace": "green", "professional-services": "green", "gambling": "red", "adult": "red" }, exclusions: ["gambling", "adult"], strengths: ["multi-currency", "international", "fx-optimization", "global-payouts"] },
];
...
// Scoring dimensions for display
export const SCORING_DIMENSIONS = [
  { dimension: "Base Score", maxPoints: 50, logic: "Every surviving provider starts here" },
  { dimension: "Risk Fit", maxPoints: 20, logic: "Green industry match = +20, Amber = +5" },
  { dimension: "Volume Alignment", maxPoints: 15, logic: "Enterprise (≥£100k) or low-volume (<£10k) match" },
  { dimension: "Priority Match", maxPoints: "10 each", logic: "low-fees, fast-setup, international, developer-friendly" },
  { dimension: "Feature Fit", maxPoints: 15, logic: "Subscriptions (+10), split payments (+15), in-person (+10)" },
